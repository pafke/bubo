            ...
            <div class="row no-gutter">
                <div class="col-lg-3 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio/test-image.jpg" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio/test-image2.jpg" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <a href="#" class="portfolio-box">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio/test-image3.jpg" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <a href="#" class="portfolio-box">
